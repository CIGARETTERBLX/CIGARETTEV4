...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		local res = game:HttpGet("https://raw.githubusercontent.com/CIGARETTERBLX/CIGARETTEV4/main/"..scripturl, true)
...
local function checkassetversion()
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/CIGARETTERBLX/CIGARETTEV4/main/assetsversion.dat",
		Method = "GET"
	})
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/CIGARETTERBLX/CIGARETTEV4/main/"..id..".vape",
		Method = "GET"
	}) end)
	if not suc then
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/CIGARETTERBLX/CIGARETTEV4/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
